                  ...
                  <div class="x_content">
                    ...
                    <form action="../airport/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Section2 İçerik<span class="required">*</span>
                        </label>
                        <?php //CKEDİTÖR BAŞLANGIÇ ?>
                      <div class="form-group">
                         <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea class="ckeditor" id="editor1" name="blog_section2"><?php echo $ayarcek['blog_section2']; ?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" name="section2kaydet" class="btn btn-success">Güncelle</button>
                        </div>
                      </div>
